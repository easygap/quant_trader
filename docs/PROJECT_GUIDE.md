...
| ✅ **target-weight exp75 회전율 완화 검증 완료** | exp75/rankrisk90/pdd10/floor40 후보에 `tol3`, `tol5`, `maxnew2`, `tol3_maxnew2` 변형을 추가했다. top-200 sweep에서는 `tol3`가 return +78.19%, raw excess +46.30%p, MDD -19.50%, turnover/year 887.6%, WF positive/Sh+ 100%로 canonical 평가 대상에 남았다. canonical에서는 return +184.09%, benchmark excess +34.70%p, Sharpe 1.51, PF 4.90, MDD -19.24%, WF positive/Sh+ 100%였지만 turnover/year 1009.0%로 provisional gate를 9.0%p 초과해 `paper_only`다 |
...
| 다음 후보 탐색 | top-200 리스크 완화·저회전·변동성 타깃·리스크 페널티 랭킹·churn control·drawdown guard sweep과 canonical 손실방어 재검증을 모두 확인했다. pdd8/floor25 후보는 MDD와 turnover를 크게 낮췄지만 canonical top-20 벤치마크를 이기지 못했고, exp75/rankrisk90/pdd10/floor40 후보는 초과수익·WF 안정성·MDD는 통과권이지만 turnover/year가 원본 1026.3%, tol3 1009.0%라 1000%/y 게이트에 걸렸다. 다음 후보 탐색은 tol4/tol5 canonical 비교나 turnover 비용 민감도 기준을 별도로 확인하는 쪽이며, 기존 canonical provisional 후보의 paper pilot은 별도 운영 단계로 유지한다. research artifact만으로 신규 paper/live 전환은 진행하지 않는다 |
