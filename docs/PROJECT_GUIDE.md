...
| 다음 후보 탐색 | top-200 리스크 완화 sweep에서 수익성은 확인했지만 MDD·회전율 병목이 유지됨. 다음 후보는 격월/분기 리밸런싱, 변동성 타깃, 낙폭 차단, 회전율 패널티 랭킹처럼 거래 빈도와 낙폭을 동시에 낮추는 방향을 우선 검증한다. 기존 canonical provisional 후보의 paper pilot은 별도 운영 단계로 유지하되, top-200 리스크 완화 결과만으로 신규 paper/live 전환은 진행하지 않는다 |
