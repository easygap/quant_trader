...
| 다음 후보 탐색 | top-200 리스크 완화·저회전·변동성 타깃·리스크 페널티 랭킹·churn control·drawdown guard sweep을 모두 확인했다. 손실방어 후보군은 pdd8/floor25/cooldown1 조합에서 return +99.53%, raw excess +67.64%p, exposure-matched excess +83.07%p, MDD -19.56%, turnover/year 296.4%로 기존 top-200 병목이던 MDD와 회전율을 동시에 낮췄고, research sweep 판정은 `RUN_CANONICAL_EVALUATION`이다. 다음은 best 후보와 `exp75_rankrisk90_pdd10_floor40_cd1` 후보를 canonical promotion evaluation에 올려 next-open/canonical metadata/paper adapter 기준 재현성을 확인한다. 기존 canonical provisional 후보의 paper pilot은 별도 운영 단계로 유지하며, research artifact만으로 신규 paper/live 전환은 진행하지 않는다 |
