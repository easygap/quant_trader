...
| **test_paper_evidence.py** | Paper Evidence 수집/검증 (55건): JSONL I/O, canonical 날짜 정렬/idempotency, promotion period, anomaly detection, benchmark missing, E2E replay 7일, cash-only zero-return deadlock regression, shadow evidence 분리, target-weight shadow plan evidence. |
