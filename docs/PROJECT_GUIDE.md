...
| 다음 후보 탐색 | 새 알파 탐색보다 target-weight pilot을 shadow/dry-run evidence 3 clean days → cap 조정 승인 → capped paper 순서로 돌려 execution-backed evidence 품질을 검증 |
