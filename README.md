...
> - Research sweep: 기존 top-20 all-family 후보 14개 재검증도 `NO_ALPHA_CANDIDATE`; `pullback`, benchmark-relative momentum, risk-budget, cash-switch 후보군과 exposure-matched benchmark 진단을 research-only로 추가
