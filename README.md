...
> - target-weight 변동성 타깃 후보군: benchmark 실현 변동성과 낙폭 기준으로 목표 노출을 직접 축소하는 research-only family 추가
