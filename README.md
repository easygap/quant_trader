...
> - target-weight 포지션 손실 감산 canonical 평가: `tol5+sectorcap2+posloss8` 후보가 return +198.15%, MDD -17.18%, turnover/year 993.9%로 신규 `provisional_paper_candidate`; pilot plan은 rank penalty/sector cap/포지션 손실 감산을 재현하고, 누적 NAV 상태가 필요한 portfolio drawdown guard는 별도 상태 모델 전까지 fail-closed 차단
