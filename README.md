...
**Python으로 만든 국내 주식·ETF 자동매매 프로그램**

투자할 종목과 비중을 정하면 그에 맞춰 매수·매도하고, 웹 화면에서 투자금과 수익률을 확인할 수 있습니다. 한국투자증권 KIS API를 지원하며, 기본 설정은 모의투자입니다.

[설치 방법](#설치-및-실행) · [백테스트 결과](docs/RISK_REVIEW_20260922.md) · [문의·오류 제보](https://github.com/easygap/quant_trader/issues/new/choose)
