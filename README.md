...
> - target-weight 포지션 손실 감산 canonical 평가: `tol5+sectorcap2+posloss8` 후보가 return +198.15%, MDD -17.18%, turnover/year 993.9%로 신규 `provisional_paper_candidate`; pilot plan 미지원 파라미터는 fail-closed 차단
