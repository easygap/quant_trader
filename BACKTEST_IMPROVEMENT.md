...
| target-weight 저회전 후보군 | 높음 | 구현 완료 — `target_weight_turnover_relief` family가 기존 risk overlay/tolerance 후보를 격월·분기 리밸런싱으로 재검증할 수 있게 함. 다음 full sweep에서 MDD·turnover 병목 완화 여부 확인 |
