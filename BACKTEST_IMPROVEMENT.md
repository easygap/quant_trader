...
| target-weight portfolio drawdown guard 후보군 | 높음 | 검증 완료 — `--candidate-family target_weight_drawdown_guard --top-n 200` full sweep에서 후보 5개 비교. best=`target_weight_rotation_top5_60_120_floor0_hold3_risk60_35_tol5_rankrisk60_pdd8_floor25_cd1`, return +99.53%, raw excess +67.64%p, exposure-matched excess +83.07%p, avg exposure 56.5%, Sharpe 1.02, PF 4.88, MDD -19.56%, turnover/year 296.4%. guard trigger 17회, guard rebalance 20회(74.1%)로 동작했고 2개 후보가 research sweep 기준 `provisional_paper_candidate`라 판정=`RUN_CANONICAL_EVALUATION`. 다음은 eligible 2개 후보 canonical promotion evaluation이며, research artifact만으로 paper/live 전환은 금지 |
