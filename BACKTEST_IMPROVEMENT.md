...
| target-weight portfolio drawdown guard 후보군 | 높음 | canonical 검증 완료 — `target_weight_drawdown_guard` family에 exp75/rankrisk90/pdd10/floor40 기반 `tol3`, `tol5`, `maxnew2`, `tol3_maxnew2` 변형을 추가하고 `--top-n 200` full sweep에서 후보 9개 비교. 새 `tol3` 후보는 return +78.19%, raw excess +46.30%p, MDD -19.50%, turnover/year 887.6%, WF positive/Sh+ 100%로 research 기준 canonical 평가 대상에 포함됐다. canonical 재평가에서는 pdd8/floor25 후보가 benchmark excess -6.46%p로 `paper_only`, exp75 원본이 turnover/year 1026.3%로 `paper_only`, exp75 tol3 후보도 return +184.09%, benchmark excess +34.70%p, Sharpe 1.51, PF 4.90, MDD -19.24%, WF positive/Sh+ 100%였지만 turnover/year 1009.0%로 `paper_only`. 기존 risk-overlay 후보만 provisional 유지. 다음은 tol4/tol5 canonical 비교 또는 turnover 비용 민감도 기준 확인 |
