...
# 대체공휴일 규정(설·추석 연휴, 3·1절, 광복절, 개천절, 한글날, 어린이날,
# 부처님오신날, 성탄절은 주말 겹침 시 다음 평일 대체; 신정·현충일은 미적용)과
# KRX 연말 휴장(마지막 거래일 12/31)을 포함한다 — 누락되면 휴장일이 거래일로
...
FALLBACK_BY_YEAR = {
    ...
    2027: {
        ...
        "2027-10-03", "2027-10-04", "2027-10-05", "2027-10-06",
        "2027-10-07",                 # 개천절(일) 대체(추석 연휴 직후 평일)
