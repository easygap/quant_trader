...
- Research candidate sweep: `tools/research_candidate_sweep.py`가 promotion/live artifact와 분리된 후보 랭킹을 생성하고 benchmark excess 음수 후보를 상위 alpha 후보에서 배제
...
- [x] **테스트 292건 회귀 green** — live/paper/promotion/research sweep 회귀 묶음 기준
